// app/admin/estados/nuevo/page.jsx - CON NÚMEROS CORREGIDOS
'use client';

import { useState, useEffect } from 'react';
import { useRouter } from 'next/navigation';
import Link from 'next/link';
import { Save, ArrowLeft, Plus, Trash2, Calendar, DollarSign, User, Building2, FileText, LogOut, Home } from 'lucide-react';
      ...
      <div className="container px-4 py-8 mx-auto">
        <div className="max-w-4xl mx-auto">
          ...
          <form id="estado-cuenta-form" onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="p-6 text-gray-700 bg-white border-l-4 border-orange-500 rounded-lg shadow-md">
