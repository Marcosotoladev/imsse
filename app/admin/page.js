// app/admin/page.jsx - Login actualizado para el nuevo sistema
'use client';
      ...
      <div className="w-full max-w-md p-8 space-y-8 bg-white border border-gray-200 rounded-lg shadow-lg">
        ...
        <div className="p-4 mt-6 border border-blue-200 rounded-lg bg-blue-50">
          <div className="flex items-start">
            ...
            <div>
              <h4 className="mb-1 text-sm font-medium text-blue-800">Sistema actualizado</h4>
              <p className="text-xs text-blue-700">
                ✅ Usuarios existentes: Migración automática al nuevo sistema.<br/>
                ✅ Nuevos usuarios: Acceso completo al portal.<br/>
                ✅ APIs optimizadas para mejor rendimiento.
              </p>
            </div>
          </div>
        </div>
